...
public class TraderNPC implements CustomTrader {
  ...
  public static final String STRING_NAME = "<b><gradient:#9F0B00:#4C504F>ѕᴘᴀᴡɴ ᴛʀᴀᴅᴇʀ";
  ...
  public boolean spawn(Location location, String name) {
    ...
    EntityProperty<LookType> lookProperty = npcApi.getPropertyRegistry().getByName("look", LookType.class);
